...
const PortfolioModel = require("../aModel/hPortfolioModel")
const PortfolioCardModel = require("../aModel/iPortfolioCardModel")
const { idToObject } = require("../../cUtils/eIDToObject")
const { handleImage } = require("../../cUtils/fHandleImage")


exports.portfolioController = (Model= PortfolioModel, Label= 'Portfolio') => {
    return {
        // List Controller
